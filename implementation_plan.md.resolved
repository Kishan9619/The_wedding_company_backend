...
#### [NEW] [config.py](file:///Users/0xkarthik/Desktop/backend/app/config.py)
- Configuration settings (database URL, secret key, etc.)

#### [NEW] [database.py](file:///Users/0xkarthik/Desktop/backend/app/database.py)
- `AsyncIOMotorClient` setup.
- Helper functions to get master DB and dynamic org collections.

#### [NEW] [models.py](file:///Users/0xkarthik/Desktop/backend/app/models.py)
...
#### [NEW] [auth.py](file:///Users/0xkarthik/Desktop/backend/app/auth.py)
- Password hashing (bcrypt).
- JWT token creation and validation/dependency.

#### [NEW] [routers/org.py](file:///Users/0xkarthik/Desktop/backend/app/routers/org.py)
...
#### [NEW] [routers/auth.py](file:///Users/0xkarthik/Desktop/backend/app/routers/auth.py)
